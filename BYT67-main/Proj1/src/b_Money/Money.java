...
public class Money implements Comparable {
	...
	public String toString() {
		 if(amount==0)return "0.0" + " " + currency.getName();
	        String money = ""+amount;
	        if(money.length()<3) throw new NumberFormatException();
	        return money.substring(0, money.length()-2) + "." + money.substring(money.length()-2) + " " + currency.getName();
	}
