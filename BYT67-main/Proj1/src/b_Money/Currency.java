...
public class Currency {
	...
	public void setRate(Double rate) 
		throws RateCanNotBeSetToNullException, RateMustBePositiveException {
	        if(rate==null) throw new RateCanNotBeSetToNullException();
	        if(rate<=0) throw new RateMustBePositiveException();
			this.rate = rate;
		}
